...
app.get("/users", async (req, res) => {
  // const users = [
  //   { id: 1, name: "John Doe" },
  //   { id: 2, name: "Sharon White" },
  //   { id: 3, name: "Rock Williams" },
  // ];
...
const contacts = [
  ...
  { name: "Sharon White", email: "sharonwhite.com" },
  { name: "Rock Williams", email: "rockwilliams@gmail.com" },
  { name: "Bob Potter", email: "bobpotter@gmail.com" },
  { name: "Ron Great", email: "rongreat@gmail.com" },
  { name: "Petter Won", email: "petterwon@gmail.com" },
];
